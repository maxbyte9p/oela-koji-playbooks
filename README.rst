...
This is a fork of kdreyer's koji-playbooks.

https://github.com/ktdreyer/koji-playbooks

This fork mainly focuses on making a few tweaks and including a setup.yml
playbook. The setup.yml playbook runs locally and is geared towards Rocky
Linux. It assumes the user does not have any of the pre-requisites needed
to run the vagrant virtual machine.

This fork is also meant to aid OpenELA development by providing a
reproducible Koji instance for testing and developing tools.

One tool that has been tested regulary is Oela Importer.

https://github.com/maxbyte9p/oela-importer/
